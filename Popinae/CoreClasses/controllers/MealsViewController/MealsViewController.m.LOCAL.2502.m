...
-(void)callService{
   ...
   // [delegate.location stopUpdatingLocation];
     ...
     if([delegate locationServicesEnabled]){
    ...
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"WARNING" message:@"PLEASE ENABLE LOCATION SERVICES FROM SETTING FOR POPINAE" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    }else if([segue.identifier isEqualToString:@"CartViewController"]){
        
        CartViewController* cartViewController = (CartViewController*)segue.destinationViewController;
       cartViewController.selectedMeal = (Meal*)sender;
    }
}
...
- (void)swipeableTableViewCell:(SWTableViewCell *)cell didTriggerRightUtilityButtonWithIndex:(NSInteger)index {
    switch (index) {
        ...
        [self performSegueWithIdentifier:@"CartViewController" sender:meal];

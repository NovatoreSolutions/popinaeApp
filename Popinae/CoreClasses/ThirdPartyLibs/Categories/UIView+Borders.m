...
-(void)addTopBorderWithHeight: (CGFloat)height andColor:(UIColor*)color{
    ...
    [self addOneSidedBorderWithFrame:CGRectMake(0, 0, frame.size.width, height) andColor:color];
}

-(void)addTopBorderWithHeight: (CGFloat)height originX:(CGFloat)origin andColor:(UIColor*)color{
    [self addOneSidedBorderWithFrame:CGRectMake(origin, 0, self.frame.size.width-origin, height) andColor:color];
}
...
-(void)addBottomBorderWithHeight: (CGFloat)height andColor:(UIColor*)color{
    ...
    CGRect frame = [UIScreen mainScreen].bounds;
    [self addOneSidedBorderWithFrame:CGRectMake(0, self.frame.size.height-height, frame.size.width, height) andColor:color];
}
